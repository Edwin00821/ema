...
values
  ...
  (10, 'Calculo Integral', 15, 1),
  (11, 'Física III', 15, 1),
  (12, 'Química III', 15, 1),
  (13, 'ORIENTACIÓN JUVENIL Y PROFESIONAL III', 15, 1),
  (14, 'INGLÉS V', 15, 1),
...
values
  ...
  (36, 'Broser API ', 1, 19, 1),
  (37, '¿Qué es React?', 1, 19, 1),
  (38, 'Class Components vs Functional Component ', 1, 19, 1);
