...
const TablesOfDataBase = ({
  ...
  return (
    <Link href={`/admin/${title}`}>
      <a className='mb-4 flex w-full flex-col gap-8 rounded-2xl border-2 border-transparent bg-white p-8 drop-shadow-lg transition-all hover:border-secondary-light dark:bg-tertiary-light md:flex-row'>
        {/* Icon */}
